        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3">
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61582245794929" className="group p-2.5 bg-white/5 rounded-xl border border-slate-800 hover:border-teal-500/50 hover:bg-teal-500/10 transition-all duration-300">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/" className="group p-2.5 bg-white/5 rounded-xl border border-slate-800 hover:border-teal-500/50 hover:bg-teal-500/10 transition-all duration-300">
                <svg className="h-5 w-5 text-slate-400 group-hover:text-teal-400 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/feed/" className="group p-2.5 bg-white/5 rounded-xl border border-slate-800 hover:border-teal-500/50 hover:bg-teal-500/10 transition-all duration-300">
                <svg className="h-5 w-5 text-slate-400 group-hover:text-teal-400 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
